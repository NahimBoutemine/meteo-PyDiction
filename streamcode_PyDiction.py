...
#Présentation du projet : titre, contexte, définition projet, objectifs du projet et de l'application:
  ...
  if st.button('Cliquer ici pour afficher la description du projet et de cette application'):
    ...
    st.markdown("Les données sont issues de https://www.kaggle.com/jsphyg/weather-dataset-rattle-package et sont des données météorologiques de pluie, ensoleillement, températures, pression, vent, humidité, sur plusieurs années, sur 49 stations réparties sur tout le territoire australien.")
