...
#Présentation du projet : titre, contexte, définition projet, objectifs du projet et de l'application:
  ...
  st.markdown("Le but a été de contruire un modèle de prédiction de la variable nommée 'RainTomorrow'. Cette variable représente la présence de pluie à jour J + 1 sur un point du territoire australien) qui vaut tout simplement 1 si la pluie est > 1mm, 0 sinon.")
